...
public class AutonomousRedAtShoot extends OpMode {
    ...
    public void buildPaths() {
        // start -> shoot (constant 222°)
        driveStartPosShootPos = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(123.235, 122.161), new Pose(92.388, 91.712)))
        ...
        driveShootPosFirstCycleIntakePrep = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(92.388, 91.712), new Pose(92.388, 83.512)))
        ...
        driveIntakePrepIntakeCollect = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(92.388, 83.512), new Pose(126.187, 83.512)))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();

        // first intake collect -> shoot (turn 0° -> 222°)
        driveIntakeCollectShootPos = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(126.187, 83.512), new Pose(92.388, 91.712)))
