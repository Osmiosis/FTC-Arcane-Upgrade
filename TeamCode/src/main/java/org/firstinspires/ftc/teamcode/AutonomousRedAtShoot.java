...
public class AutonomousRedAtShoot extends OpMode {
    ...
    public void buildPaths() {
        ...
        // Nudged Y from 83.512 -> 80.5 to better align with first ball row
        driveShootPosFirstCycleIntakePrep = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(95.388, 91.712), new Pose(92.388, 80.5)))
        ...
        driveIntakePrepIntakeCollect = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(92.388, 80.5), new Pose(129.0, 80.5)))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();

        // first intake collect -> shoot (turn 0° -> 222°)
        driveIntakeCollectShootPos = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(129.0, 80.5), new Pose(95.388, 91.712)))
